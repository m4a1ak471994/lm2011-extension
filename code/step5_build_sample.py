...
MAN = Path(os.environ.get(
    "LM_MANIFEST_PATH",
    str(DATA_ROOT / "manifest" / "filings_10k_1993_2026.parquet"),
))
WC = OUT / "filing_word_counts.parquet"
COMPHIST = INP / "comphist_cik_gvkey.dta"
COMPUSTAT = INP / "compustat_gvkey_permno.dta"
CRSP_DAILY = INP / os.environ.get("LM_CRSP_DAILY", "crsp_daily_1993_2026.dta")
CRSP_MONTHLY = INP / os.environ.get("LM_CRSP_MONTHLY", "crsp_monthly_1993_2026.dta")
...
def main() -> None:
    ...
    crspd = load_crsp_daily_min(years=(1993, 2026))
